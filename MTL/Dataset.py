...
class train_Dataset(Dataset):
    ...
    IMAGE_PATH_seg = os.path.join("/home/skim/dataset/segmentation/fold2_10/train_img")
    MASK_PATH_seg = os.path.join("/home/skim/dataset/segmentation/fold2_10/train_mask")
    IMAGE_PATH_det = os.path.join("/home/skim/dataset/detection/fold2/train_img")
    MASK_PATH_det = os.path.join("/home/skim/dataset/detection/fold2/train_mask")
    def __init__(
        self,
        data_dir: str,
...
class val_Dataset(Dataset):
    ...
    IMAGE_PATH_seg = os.path.join(
        "/home/skim/dataset/segmentation/fold2_10/val_img")
    MASK_PATH_seg = os.path.join(
        "/home/skim/dataset/segmentation/fold2_10/val_mask")
    IMAGE_PATH_det = os.path.join("/home/skim/dataset/detection/fold2/val_img")
    MASK_PATH_det = os.path.join("/home/skim/dataset/detection/fold2/val_mask")
...
class Total_Dataset(Dataset):
        ...
        IMAGE_PATH = os.path.join(
            "/home/skim/PycharmProjects/pythonProject/lightning-bolts-master/pl_bolts/models/detection/dataset/dataset_split/test/images")
        MASK_PATH = os.path.join(
            "/home/skim/PycharmProjects/pythonProject/lightning-bolts-master/pl_bolts/models/detection/dataset/dataset_split/test/masks")
