...
class SemSegment(LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        self.log('train_dice_lymphocytes', dice1, on_step=False, on_epoch=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_dice_background', dice0, on_step=False, on_epoch=True, sync_dist=True)
        self.log('val_dice_lymphocytes', dice1, on_step=False, on_epoch=True, sync_dist=True)
        self.log('val_bce_loss', bce_loss, on_step=False, on_epoch=True, sync_dist=True)
